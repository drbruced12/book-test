...
exclude_patterns = [u'_build', 'venv-docs', 'requirements.txt', 'Thumbs.db', 'private', '.DS_Store', '*/README.rst', 'software/directory.rst']
...
latex_documents = [
    (master_doc, 'book.tex', u'Private 5G: A Systems Approach',
...
texinfo_documents = [
    (master_doc, 'Private 5G', u'Private 5G',
